...
public class actResumoConta1 extends actBaseListas implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_resumo_conta1);
    ...
    protected void inicializaObjetos() {
        ...
        ActionBarHelper.menuHome(getSupportActionBar(), this.getString(R.string.lblConta));
